...
<div class="container">
    <div class="content">
        ...
        <div class="main-content">
            <div class = "regform"><h2>Lecturer Registration Form</h2></div>
            <div class = "main">
                ...
                <form id="form" method = "post" action = "<%=request.getContextPath()%>/LecturerInsertServlet">
                    ...
                    <div class="form-control">
                        ...
                        <input class ="ID "type="text" name="staffId" placeholder="Enter Staff ID Number.." required>

                        <h2 class ="name"> N.I.C</h2>
                        <input class="NIC" type="text" name="NIC" placeholder="Enter N.I.C.." required>

                        <h2 class ="name">Name</h2>
                        <input class ="FullName" type ="text" name="name" placeholder ="Enter Name" required>

                        <h2 class="name">Section</h2>
                        <input class="Section" type="text" name="section" placeholder="Enter section.." required>

                        <h2 class="name">E-Mail </h2>
                        <input class="Email" type="text" name="email" placeholder="Enter email address.." required>
