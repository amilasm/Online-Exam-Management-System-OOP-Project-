...
public class LecturerService {
    ...
    public static List<Lecturer> LecturerRecordsRetrieve() {         //records retrieve
    ...
    public static void  LecturerRecordsInsert(Lecturer lec) {   //insert new lecture
        try {
    ...
    public  boolean LecturerRecordDelete(int userId)throws SQLException {  //delete lecturer record
        Lecturer lec=null;
    ...
    public static boolean UpdateLectureRecords(Lecturer lec) throws SQLException {  //update lecturer details
